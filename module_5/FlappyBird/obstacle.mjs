...
class TObstacle {
    ...
    constructor(aSpriteCanvas, aSpriteInfo) {
        this.#spi = GameProps.dayTime ? SpriteInfoList.obstacle : SpriteInfoList.obstacle2;
        const minTop = -320 + 25;
    ...
    update(){
        ...
        if(hasCollided){
            ...
            const gameOverSound = GameProps.sounds.gameOver;
      gameOverSound.stop();
      gameOverSound.play();
        }
      }
     ...
     updateSprite() {
        const nSpriteInf = GameProps.dayTime
        ? SpriteInfoList.obstacle : SpriteInfoList.obstacle2;
    
        this.#upper.spriteInfo = nSpriteInf;
        this.#lower.spriteInfo = nSpriteInf;
